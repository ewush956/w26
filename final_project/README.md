...
> *Pending registrar's schedule. Most of your project should be complete for the presentation, but you can put finishing touches on your report in the days afterwards.
...
- [Hugging Face](https://huggingface.co/datasets) - A popular data- and model-sharing site, and the successor to the now-defunct "Papers with Code" (RIP)
...
- [Google BigQuery Datasets](https://console.cloud.google.com/marketplace/browse?filter=solution-type:dataset&hl=en) - we'll be using this in assignment 3, so I'll provide guidance on accessing it
